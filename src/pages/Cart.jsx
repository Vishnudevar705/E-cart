      ...
      <div style={{paddingTop:"100px"}} className='0x-5'>
        ...
        <div className='grid grid-cols-3 gap-4 mt-5'>
          <div className='col-span-2 border rounded p-5 shadow'>
            <table className='table-auto w-full'>
             ...
             <tbody>
              ...
              <td>{index+1}</td>
              <td>{product?.title}</td>
              <td><img width={"100px"} height={"150px"} src={product.thumbnail} alt="" /></td>
              <td>
                <div className='flex'>
            ...
            <div className='float-right mt-5'>
              <button onClick={()=>dispatch(emptyCart())} className='bg-red-600 rounded p-2 text-white'>Empty Card</button>
          ...
          <div className='border rounded shadow p-5'>
            ...
            <hr />
            <button onClick={checkOut} className='bg-green-600 rounded p-2 text-white w-full m-4'>Check Out</button>
